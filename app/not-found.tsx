...
export default function Custom404() {
  return (
    <>
      ...
      <h1 className="text-4xl text-blue-950 font-bold">Was ist passiert?</h1>
      ...
      <div className="glass w-fit rounded-3xl p-2">
        <h3 className="text-2xl text-blue-950/75 font-bold flex items-center">
          <Info className="mr-2" />
          Hinweis
        </h3>
      ...
      <h1 className="text-4xl text-blue-950 font-bold">Lösungs ansatz</h1>
      ...
      <h1 className="text-4xl text-blue-950 font-bold">Problem vermeinden</h1>
